...
# ---
print(f"exc_mon.t max: {exc_mon.t[-1]/second} seconds")
print(f"inh_mon.t max: {inh_mon.t[-1]/second} seconds")
print(f"astro_mon_C.t max: {astro_mon_C.t[-1]/second} seconds")
print(f"astro_mon_G_A.t max: {astro_mon_G_A.t[-1]/second} seconds")
